...
class AddPrimaryKeyRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i308 in xrange(_size304):
            ...
            _elem309.read(iprot)
            self.primaryKeyCols.append(_elem309)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.primaryKeyCols is not None:
      ...
      for iter310 in self.primaryKeyCols:
        iter310.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddForeignKeyRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i315 in xrange(_size311):
            ...
            _elem316.read(iprot)
            self.foreignKeyCols.append(_elem316)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.foreignKeyCols is not None:
      ...
      for iter317 in self.foreignKeyCols:
        iter317.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddUniqueConstraintRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i322 in xrange(_size318):
            ...
            _elem323.read(iprot)
            self.uniqueConstraintCols.append(_elem323)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.uniqueConstraintCols is not None:
      ...
      for iter324 in self.uniqueConstraintCols:
        iter324.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AddNotNullConstraintRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i329 in xrange(_size325):
            ...
            _elem330.read(iprot)
            self.notNullConstraintCols.append(_elem330)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.notNullConstraintCols is not None:
      ...
      for iter331 in self.notNullConstraintCols:
        iter331.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class TableStatsResult:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i343 in xrange(_size339):
            _elem344 = ColumnStatisticsObj()
            _elem344.read(iprot)
            self.tableStats.append(_elem344)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.tableStats is not None:
      ...
      for iter345 in self.tableStats:
        iter345.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class PartitionsStatsResult:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i350 in xrange(_size346):
            ...
            iprot.readListEnd()
            self.partStats[_key351] = _val352
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partStats is not None:
      ...
      for kiter359,viter360 in self.partStats.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i379 in xrange(_size375):
            ...
            self.partNames.append(_elem380)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddPartitionsResult:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i387 in xrange(_size383):
            _elem388 = Partition()
            _elem388.read(iprot)
            self.partitions.append(_elem388)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitions is not None:
      oprot.writeFieldBegin('partitions', TType.LIST, 1)
      oprot.writeListBegin(TType.STRUCT, len(self.partitions))
      for iter389 in self.partitions:
        iter389.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i414 in xrange(_size410):
            _elem415 = DropPartitionsExpr()
            _elem415.read(iprot)
            self.exprs.append(_elem415)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class PartitionValuesRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i422 in xrange(_size418):
            _elem423 = FieldSchema()
            _elem423.read(iprot)
            self.partitionKeys.append(_elem423)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        ...
        if ftype == TType.LIST:
          ...
          for _i428 in xrange(_size424):
            _elem429 = FieldSchema()
            _elem429.read(iprot)
            self.partitionOrder.append(_elem429)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.partitionKeys is not None:
      ...
      oprot.writeListBegin(TType.STRUCT, len(self.partitionKeys))
      for iter430 in self.partitionKeys:
        iter430.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    ...
    if self.partitionOrder is not None:
      ...
      for iter431 in self.partitionOrder:
        iter431.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class PartitionValuesResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i443 in xrange(_size439):
            _elem444 = PartitionValuesRow()
            _elem444.read(iprot)
            self.partitionValues.append(_elem444)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionValues is not None:
      ...
      for iter445 in self.partitionValues:
        iter445.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class Function:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i450 in xrange(_size446):
            _elem451 = ResourceUri()
            _elem451.read(iprot)
            self.resourceUris.append(_elem451)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourceUris is not None:
      ...
      for iter452 in self.resourceUris:
        iter452.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i457 in xrange(_size453):
            _elem458 = TxnInfo()
            _elem458.read(iprot)
            self.open_txns.append(_elem458)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i464 in xrange(_size460):
            ...
            self.open_txns.append(_elem465)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
...
class GetValidWriteIdsRequest:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i485 in xrange(_size481):
            ...
            self.fullTableNames.append(_elem486)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.fullTableNames is not None:
      ...
      for iter487 in self.fullTableNames:
...
class TableValidWriteIds:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i492 in xrange(_size488):
            ...
            self.invalidWriteIds.append(_elem493)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.invalidWriteIds is not None:
      ...
      for iter494 in self.invalidWriteIds:
...
class GetValidWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i499 in xrange(_size495):
            _elem500 = TableValidWriteIds()
            _elem500.read(iprot)
            self.tblValidWriteIds.append(_elem500)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.tblValidWriteIds is not None:
      ...
      for iter501 in self.tblValidWriteIds:
        iter501.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class AllocateTableWriteIdsResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i513 in xrange(_size509):
            _elem514 = TxnToWriteId()
            _elem514.read(iprot)
            self.txnToWriteIds.append(_elem514)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.txnToWriteIds is not None:
      ...
      for iter515 in self.txnToWriteIds:
        iter515.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i520 in xrange(_size516):
            _elem521 = LockComponent()
            _elem521.read(iprot)
            self.component.append(_elem521)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i527 in xrange(_size523):
            _elem528 = ShowLocksResponseElement()
            _elem528.read(iprot)
            self.locks.append(_elem528)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.SET:
          self.aborted = set()
          (_etype533, _size530) = iprot.readSetBegin()
          for _i534 in xrange(_size530):
            _elem535 = iprot.readI64()
            self.aborted.add(_elem535)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.SET:
          self.nosuch = set()
          (_etype539, _size536) = iprot.readSetBegin()
          for _i540 in xrange(_size536):
            _elem541 = iprot.readI64()
            self.nosuch.add(_elem541)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      else:
...
class CompactionRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i548 in xrange(_size544):
            ...
            self.properties[_key549] = _val550
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.properties is not None:
      ...
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.properties))
      for kiter551,viter552 in self.properties.items():
        oprot.writeString(kiter551)
        oprot.writeString(viter552)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i557 in xrange(_size553):
            _elem558 = ShowCompactResponseElement()
            _elem558.read(iprot)
            self.compacts.append(_elem558)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class AddDynamicPartitions:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i564 in xrange(_size560):
            ...
            self.partitionnames.append(_elem565)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
  ...
  def write(self, oprot):
    ...
    if self.partitionnames is not None:
      ...
      for iter566 in self.partitionnames:
        oprot.writeString(iter566)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.operationType is not None:
      oprot.writeFieldBegin('operationType', TType.I32, 6)
...
class CreationMetadata:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.SET:
          self.tablesUsed = set()
          (_etype570, _size567) = iprot.readSetBegin()
          for _i571 in xrange(_size567):
            _elem572 = iprot.readString()
            self.tablesUsed.add(_elem572)
          iprot.readSetEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      for iter573 in self.tablesUsed:
        oprot.writeString(iter573)
      oprot.writeSetEnd()
      oprot.writeFieldEnd()
    if self.validTxnList is not None:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i578 in xrange(_size574):
            _elem579 = NotificationEvent()
            _elem579.read(iprot)
            self.events.append(_elem579)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class InsertEventRequestData:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i585 in xrange(_size581):
            ...
            self.filesAdded.append(_elem586)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i591 in xrange(_size587):
            ...
            self.filesAddedChecksum.append(_elem592)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.filesAdded is not None:
      ...
      for iter593 in self.filesAdded:
    ...
    if self.filesAddedChecksum is not None:
      ...
      for iter594 in self.filesAddedChecksum:
...
class FireEventRequest:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i599 in xrange(_size595):
            ...
            self.partitionVals.append(_elem600)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.partitionVals is not None:
      ...
      for iter601 in self.partitionVals:
...
class GetFileMetadataByExprResult:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i606 in xrange(_size602):
            ...
            _val608 = MetadataPpdResult()
            _val608.read(iprot)
            self.metadata[_key607] = _val608
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.metadata is not None:
      ...
      for kiter609,viter610 in self.metadata.items():
        oprot.writeI64(kiter609)
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i659 in xrange(_size655):
            _elem660 = Function()
            _elem660.read(iprot)
            self.functions.append(_elem660)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class ClientCapabilities:
  ...
  def write(self, oprot):
    ...
    if self.values is not None:
      ...
      for iter668 in self.values:
        oprot.writeI32(iter668)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class Materialization:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      oprot.writeSetBegin(TType.STRING, len(self.tablesUsed))
      for iter689 in self.tablesUsed:
...
class WMFullResourcePlan:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i712 in xrange(_size708):
            _elem713 = WMPoolTrigger()
            _elem713.read(iprot)
            self.poolTriggers.append(_elem713)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.poolTriggers is not None:
      ...
      for iter717 in self.poolTriggers:
        iter717.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WMGetAllResourcePlanResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i722 in xrange(_size718):
            _elem723 = WMResourcePlan()
            _elem723.read(iprot)
            self.resourcePlans.append(_elem723)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourcePlans is not None:
      ...
      for iter724 in self.resourcePlans:
        iter724.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
