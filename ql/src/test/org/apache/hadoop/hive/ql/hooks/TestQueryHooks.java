...
public class TestQueryHooks {
  ...
  private IDriver createDriver(QueryLifeTimeHook mockHook) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
    ...
    IDriver driver = new IDriver(conf, mockLoader);
    return driver;
  }
