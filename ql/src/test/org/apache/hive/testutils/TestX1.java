...
public class TestX1 {
  ...
  public static void beforeClass() throws Exception {
    ...
    String cmds[] = {
        ...
        "insert into tu values (1),(2),(3),(100)",
        "create table tv(u int)",
        "insert into tv values (4),(100)",
        // @formatter:on
    };
    for (String cmd : cmds) {
  ...
  public void testMappingSameQuery() throws ParseException, Exception {
    IDriver driver = createDriver();
    String query = "select u from tu where u < 100 union all select u from tv where u < 100 ";
