...
FROM druid_t1
WHERE `__time`
    BETWEEN CAST('2010-01-01 00:00:00 America/Los_Angeles' AS TIMESTAMP WITH LOCAL TIME ZONE)
        AND CAST('2010-02-01 00:00:00 America/Los_Angeles' AS TIMESTAMP WITH LOCAL TIME ZONE)
    OR
    `__time`
    BETWEEN CAST('2010-02-03 01:00:00 America/Los_Angeles' AS TIMESTAMP WITH LOCAL TIME ZONE)
        AND CAST('2010-03-01 00:00:00 America/Los_Angeles' AS TIMESTAMP WITH LOCAL TIME ZONE)
order by `__time`;
