...
LOAD DATA LOCAL INPATH '../../../hwx/data/files/I1G.data.txt' INTO TABLE t_bad0;
LOAD DATA LOCAL INPATH '../../../hwx/data/files/I1G.data.txt' INTO TABLE t_good0;
...
set hive.auto.convert.join.noconditionaltask.size = 20000000000;
...
select sum(length(l.str||l.id||r.id||r.str||l.s1||r.s2)),count(*) from t_bad l join t_good r on (l.id=r.id and l.str=r.str);
