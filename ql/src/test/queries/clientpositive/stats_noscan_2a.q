...
explain insert into t0 values ('a','b'),('a','b'), ('a','b');
...
explain ALTER TABLE anaylyze_external ADD PARTITION (insertdate='2008-01-01') location 'pfile://${system:test.tmp.dir}/texternal/2008-01-01';
