...
public class Core111PerfCliDriver extends CliAdapter {
  ...
  public void beforeClass() {
    ...
    try {
      ...
      qt = new QTestUtil(cliConfig.getResultsDir(), cliConfig.getLogDir(), miniMR, hiveConfDir, hadoopVer, initScript,
      ...
      //      T30.setupMetaStoreTableColumnStatsFor30TBTPCDSWorkload(qt.getConf(),System.getProperty(QTestUtil.TEST_TMP_DIR_PROPERTY));
    } catch (Exception e) {
  ...
  public void runTest(String name, String fname, String fpath) throws Exception {
    ...
    try {
      ...
      if (result.getReturnCode() != 0) {
        String message =
            Strings.isNullOrEmpty(result.getCapturedOutput()) ? debugHint : "\r\n" + result.getCapturedOutput();
